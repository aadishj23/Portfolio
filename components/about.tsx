...
export default function AboutMe() {
  return (
    <div className="lg:pl-[20vw] px-5">
      ...
      <p className="w-full lg:w-3/5 my-4 dark:text-gray-300">During my time at <span className="text-red-700 cursor-pointer font-semibold"><a href="https://drive.google.com/file/d/1-hMEYI8EIGmr3i5Gx3wEZe2eaDHGmeHx/view" target="_blank">Appzlogic</a></span>, I contributed to major product features and led a complete UI revamp that significantly improved user engagement. I also helped develop the official site for the <span className="text-red-700 cursor-pointer font-semibold"><a href="https://github.com/aadishj23/Namdapha" target="_blank">Namdapha Tiger Reserve</a></span>, enhancing the digital experience for visitors and wildlife enthusiasts alike.</p>
      <p className="w-full lg:w-3/5 dark:text-gray-300 mb-4">I've held leadership roles in my college tech society, mentored web development beginners, and enjoy working on projects that make an impact. Let's connect and build something great together.</p>
