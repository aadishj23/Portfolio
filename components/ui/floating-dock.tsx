...
// Detect if the device is mobile using a custom hook
  ...
  return (
    <a href={href} target="_blank" rel="noopener noreferrer">
      <motion.div
        ...
        onMouseEnter={() => setHovered(true)}
        onMouseLeave={() => setHovered(false)}
        className="relative flex aspect-square items-center justify-center rounded-full bg-linear-to-r from-black to-[#70290A] "
      >
        <AnimatePresence>
          {hovered && !isMobile && (
            <motion.div
