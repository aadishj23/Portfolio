  ...
  const experience = [
    {
        ...
        responsibilities: [
          'Ideated & pitched Career Wallah, a personalized college-prediction and career-guidance platform; own its end-to-end development — 150,000+ active users, 200,000+ sign-ins',
          'Designed & independently built Tracker 360, a study-planning and progress-tracking platform that generates student-specific learning plans — 200,000+ active users',
          'Led the Khazana 1.0→2.0 migration: system architecture, database schema, migration pipelines, and a multi-team rollout moving 300,000+ records',
          'Owned & architected Khazana automation — autonomous ingestion of 200,000+ hours of video and 1M+ notes for a platform used by 2Cr+ students',
          'Built and scaled high-traffic exam platforms — score calculators, rank predictors & counseling tools — serving 500,000+ users',
          'Developed Node.js/Python data pipelines processing 170,000+ student result records during peak examination seasons'
        ],
        technologies: ['Next.js', 'TypeScript', 'Node.js', 'Express.js', 'Python', 'PostgreSQL', 'MongoDB', 'Redis', 'Docker'],
        impact: '350K+ active users • 500K+ exam users • 300K+ records migrated • 200K+ hrs video ingested',
